uint16_t meter8(uint16_t u16_mapStart){
  ...
  EEPROM.write(u16_mapStart + 6, highByte(u16_grpStart + 37));
  EEPROM.write(u16_mapStart + 7, lowByte(u16_grpStart + 37));


  // Block #1 - [999, 1201, 128]
  EEPROM.write(u16_blkStart, highByte(999));
  EEPROM.write(u16_blkStart + 1, lowByte(999));
  EEPROM.write(u16_blkStart + 2, highByte(1201));
  EEPROM.write(u16_blkStart + 3, lowByte(1201));
  ...
  EEPROM.write(u16_blkStart + 12, highByte(4103));
  EEPROM.write(u16_blkStart + 13, lowByte(4103));
