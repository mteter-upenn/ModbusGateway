void meter12(uint16_t mtr_start){
  ...
  EEPROM.write(blk_strt + 14, FLOAT);
  ...
  EEPROM.write(blk_strt + 24, FLOAT);
  ...
  EEPROM.write(grp_strt + 5, FLOAT);
  EEPROM.write(grp_strt + 6, FLOAT);
  ...
  EEPROM.write(grp_strt + 12, FLOAT);
  EEPROM.write(grp_strt + 13, FLOAT);
  ...
  EEPROM.write(grp_strt + 18, FLOAT);
  ...
  EEPROM.write(grp_strt + 24, FLOAT);
  EEPROM.write(grp_strt + 25, FLOAT);
  ...
  EEPROM.write(grp_strt + 30, FLOAT);
