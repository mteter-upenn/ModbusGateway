void meter7(uint16_t mtr_start){
  ...
  EEPROM.write(blk_strt + 9, S16_to_FLOAT);
  ...
  EEPROM.write(blk_strt + 19, M30K_to_FLOAT);
  ...
  EEPROM.write(blk_strt + 24, M20K_to_FLOAT);
  ...
  EEPROM.write(blk_strt + 29, S16_to_FLOAT);
  ...
  EEPROM.write(blk_strt + 34, S16_to_FLOAT);
  ...
  for (i = 1; i < 4; i++){
    ...
    EEPROM.write(i + grp_strt + 5, S16_to_FLOAT);
  }
  ...
  EEPROM.write(grp_strt + 13, S16_to_FLOAT);
  ...
  for (i = 26; i < 30; i++){
    ...
    EEPROM.write(i + grp_strt + 14, S16_to_FLOAT);
  }
  ...
  for (i = 14; i < 26; i++){
    ...
    EEPROM.write(i + grp_strt + 45, S16_to_FLOAT);
  }
  ...
  for (i = (grp_strt + 77); i < (grp_strt + 77 + 3); i++){
    EEPROM.write(i, M30K_to_FLOAT);  // data type
  }
