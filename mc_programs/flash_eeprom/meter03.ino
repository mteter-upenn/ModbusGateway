void meter3(uint16_t mtr_start){
  ...
  EEPROM.write(blk_strt + 9, M1K_to_FLOAT);
  ...
  for (i = 1; i < 5; i++){
    ...
    EEPROM.write(i + grp_strt + 25, S16_to_FLOAT);
  }
  ...
  for (i = 14; i < 18; i++){
    ...
    EEPROM.write(i + grp_strt + 35, S16_to_FLOAT);
    EEPROM.write(i + grp_strt + 39, S16_to_FLOAT);
    EEPROM.write(i + grp_strt + 43, S16_to_FLOAT);
    EEPROM.write(i + grp_strt + 47, S16_to_FLOAT);
  }
  ...
  EEPROM.write(grp_strt + 79, M1K_to_FLOAT);
  ...
  EEPROM.write(grp_strt + 74, M1K_to_FLOAT);
