void meter10(uint16_t mtr_start){
  ...
  EEPROM.write(blk_strt + 14, M20K_to_FLOAT);
  ...
  EEPROM.write(blk_strt + 19, M20K_to_FLOAT);
  ...
  EEPROM.write(grp_strt + 35, S16_to_FLOAT);
  ...
  for (i = 14; i < 26; i++){
    ...
    EEPROM.write(i + grp_strt + 37, S16_to_FLOAT);
  }
  ...
  for (i = 26; i < 30; i++){
    ...
    EEPROM.write(i + grp_strt + 44, S16_to_FLOAT);
  }
  ...
  for (i = 30; i < 33; i++){
    ...
    EEPROM.write(i + grp_strt + 50, M30K_to_FLOAT);
  }
