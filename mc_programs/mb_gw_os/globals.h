...
extern uint32_t g_u32_tcpSockTimeout;               // tcp socket timeout, triggers when there is no activity from client or anything internally relevant
...
extern bool g_b_printMbComms;                              // print modbus comms to sd card
